 ...
 * @if NOTICE
 *
 * $Id: hmplatf.h,v 1.16 2004/08/29 03:20:20 henrik Exp $
 *
...
/*
 * Windows CE/95/98/NT/2000/XP applications
 */
#if (defined(_WIN32_WCE) || defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__NT__)) && !defined(__CYGWIN__)
