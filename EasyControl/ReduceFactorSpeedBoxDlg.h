...
///
///
/// @brief  Declaration of module ReduceFactorSpeedBoxDlg
///
/// @file   ReduceFactorSpeedBoxDlg.h
///
///
...
//------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------
class CReduceFactorSpeedBoxDlg : public CSpeedBoxDlg
{
protected:
...
public:
	CReduceFactorSpeedBoxDlg() : CSpeedBoxDlg()
	{}
	~CReduceFactorSpeedBoxDlg() override = default;
