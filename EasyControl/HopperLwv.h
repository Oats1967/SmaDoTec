...
///
///
/// @brief  Declaration of module HopperLwv
///
/// @file   HopperLwv.h
///
///
...
//**********************************************************************************************************************
//**********************************************************************************************************************
class CHopperLwv : public CStandardHopper
{
...
public:
	CHopperLwv() : CStandardHopper( { base::IPoint{ FX0, FY0 },
									  base::IPoint{ FX1, FY1 },
									  base::IPoint{ FX2, FY2 },
									  base::IPoint{ FX3, FY3 },
									  base::IPoint{ FX4, FY4 },
									  base::IPoint{ FX5, FY5 } })
	{}
	CHopperLwv(const CHopperLwv& ) = default;
	CHopperLwv& operator = (const CHopperLwv& ) = default;
};
