...
///
///
/// @brief  Declaration of module FeederDisplayLwp
///
/// @file   FeederDisplayLwp.h
///
///
...
/////////////////////////////////////////////////////////////////////////////
// CFeederDisplayLwp command target

class CFeederDisplayLwp : public CFeederDisplayLwf
{
...
private:
    CFeederDisplayLwp() = delete;

public:
    CFeederDisplayLwp(const int32_t sID, const CRect& rRect);
    CFeederDisplayLwp(const CFeederDisplayLwp&) = delete;
    CFeederDisplayLwp& operator = (const CFeederDisplayLwp&) = delete;
    ~CFeederDisplayLwp() = default;
