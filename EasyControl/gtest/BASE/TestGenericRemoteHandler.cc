...
public:
    ...
    MOCK_METHOD1(setLinePBServiceMode, int32_t(const BOOL value));
    MOCK_METHOD1(getLinePBServiceMode, int32_t(BOOL & value));
...
namespace
{
    TEST(TestGenericRemoteHandler, XmlFile)
    {
    ...
    TEST(TestGenericRemoteHandler, Execute)
    {
