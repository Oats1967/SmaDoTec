...
///
///
/// @brief  Declaration of module GainFactorSpeedBoxDlg
///
/// @file   GainFactorSpeedBoxDlg.h
///
///
...
//------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------
class CGainFactorSpeedBoxDlg : public CSpeedBoxDlg
{
protected:
...
public:
	CGainFactorSpeedBoxDlg() : CSpeedBoxDlg()
	{}
	~CGainFactorSpeedBoxDlg() override = default;
