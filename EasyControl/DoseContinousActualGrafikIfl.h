...
class CDoseContinousActualGrafikIfl : public CDoseBaseActualGrafik
{
...
private:
	CDoseContinousActualGrafikIfl(void) = delete;

public:
	CDoseContinousActualGrafikIfl(const CRect& rRect) : CBaseClass(rRect)
		, cSetpointPoint{ 0, 46 }
	{}
	~CDoseContinousActualGrafikIfl(void) override = default;
	CDoseContinousActualGrafikIfl(const CDoseContinousActualGrafikIfl&) = delete;
	CDoseContinousActualGrafikIfl& operator = (const CDoseContinousActualGrafikIfl&) = delete;
};
