...
///
///
/// @brief  Declaration of module AdsSoemerLoadcellSim
///
/// @file   AdsSoemerLoadcellSim.h
///
///
...
class CAdsSoemerLoadcellSim : public IAdsLoadCellInterface
{
    struct SimData
    {
...
public:
    CAdsSoemerLoadcellSim();
    ~CAdsSoemerLoadcellSim() = default;
