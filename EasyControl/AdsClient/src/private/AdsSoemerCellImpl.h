...
///
///
/// @brief  Declaration of module AdsSoemercellImpl
///
/// @file   AdsSoemercellImpl.h
///
///
...
class CAdsSoemerLoadcellImpl : public IAdsLoadCellInterface
{
    static const  char_t c_cr = C_CR;
...
private:
    static int32_t AdsSoemerCellScanMaxWert(LPCSTR nDB, uint32_t* pPos);
    static int32_t AdsSoemerCellScanValue(LPCSTR nDB, float32_t* f);

    int32_t Command_CL(const int32_t index);
    int32_t Command_OP_EX(const int32_t index, bool bRetry);
    int32_t AdsSoemerCellScanPosition(LPCSTR nDB, uint16_t* pPos);
    int32_t AdsSoemerCellGetPosition(const int32_t index, uint16_t* pPos);
    int32_t AdsSoemerCellStart(const int32_t index, bool bWait = true);
    int32_t AdsSoemerCellDone(const int32_t index);
    int32_t AdsSoemerCellGetMaxWert(const int32_t index, uint32_t* pPos) const;

public:
    CAdsSoemerLoadcellImpl();
    ~CAdsSoemerLoadcellImpl() = default;
