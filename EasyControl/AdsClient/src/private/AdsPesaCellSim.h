...
///
///
/// @brief  Declaration of module AdsPesaCellSim
///
/// @file   AdsPesaCellSim.h
///
///
...
class CAdsPesaLoadcellSim : public IAdsLoadCellInterface
{
    struct SimData
    {
    ...
    const float32_t c_InitWeight = 2.0F;
