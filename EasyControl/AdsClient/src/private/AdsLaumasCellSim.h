...
///
///
/// @brief  Declaration of module AdsLaumasLoadcellSim
///
/// @file   AdsLaumasLoadcellSim.h
///
///
...
class CAdsLaumasLoadcellSim : public IAdsLoadCellInterface
{
    struct SimData
    {
...
public:
    CAdsLaumasLoadcellSim();
    ~CAdsLaumasLoadcellSim() = default;
