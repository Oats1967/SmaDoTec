...
///
///
/// @brief  Declaration of module HopperLws
///
/// @file   HopperLws.h
///
///
...
//**********************************************************************************************************************
//**********************************************************************************************************************
class CHopperLws : public CStandardHopper
{
...
public:
	CHopperLws() : CStandardHopper({  base::IPoint{ FX0, FY0 },
									  base::IPoint{ FX1, FY1 },
									  base::IPoint{ FX2, FY2 },
									  base::IPoint{ FX3, FY3 },
									  base::IPoint{ FX4, FY4 },
									  base::IPoint{ FX5, FY5 } })
	{}
	CHopperLws(const CHopperLws& ) = default;
	CHopperLws& operator = (const CHopperLws& ) = default;
};
