...
///
///
/// @brief  Declaration of module AgitatorSpeedBoxDlg
///
/// @file   AgitatorSpeedBoxDlg.h
///
///
...
//------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------
class CAgitatorSpeedBoxDlg : public CSpeedBoxDlg
{
protected:
...
public:
	CAgitatorSpeedBoxDlg() : CSpeedBoxDlg()
	{}
	~CAgitatorSpeedBoxDlg() override = default;
